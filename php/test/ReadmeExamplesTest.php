...
// Pogony SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (PogonySDK::test)
...
{
    private const SDK_CLASS = 'PogonySDK';
    ...
    private const SDK_BASE = 'pogony_sdk';
