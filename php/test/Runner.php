...
class PogonyTestRunner
{
    ...
    {
        $live = self::getenv('POGONY_TEST_LIVE');
        $override = self::getenv('POGONY_TEST_OVERRIDE');
        ...
        $explain = self::getenv('POGONY_TEST_EXPLAIN');
...
class_alias('PogonyTestRunner', 'Runner');
class_alias('PogonyHelpers', 'Helpers');
