...
// Pogony SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = PogonyOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(PogonyOmni::structfix($now, Struct::undef()))
                        !== json_encode(PogonyOmni::structfix($val, Struct::undef()))) {
