...
// Pogony SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class PogonyTestFeature extends PogonyBaseFeature
{
    ...
    public function init(PogonyContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (PogonyContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (PogonyContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(PogonyContext $ctx, $op, $args): array
    {
