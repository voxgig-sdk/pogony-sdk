...
class PogonyRatelimitFeature extends PogonyBaseFeature
{
    ...
    private function _acquire(PogonyContext $ctx): void
    {
    ...
    private function _track(PogonyContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
