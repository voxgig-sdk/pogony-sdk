...
class PogonyTimeoutFeature extends PogonyBaseFeature
{
    ...
    private function _with_timeout(PogonyContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(PogonyContext $_ctx, float $ms): void
    {
        $client = $this->client;
