...
import (
	...
	vs "github.com/voxgig-sdk/pogony-sdk/go/utility/struct"
)

type CriminalEntity struct {
	name    string
	client  *core.PogonySDK
...
func NewCriminalEntity(client *core.PogonySDK, entopts map[string]any) *CriminalEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CriminalEntity) GetName() string { return e.name }
...
func (e *CriminalEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CriminalEntity) Deleted() bool {
	return e.deleted
}


func (e *CriminalEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCriminalEntity(e.client, opts)
}

func (e *CriminalEntity) Data(args ...any) any {
...
func (e *CriminalEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Criminal; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CriminalEntity) DataTyped(data ...Criminal) Criminal {
	if len(data) > 0 {
		return typedFrom[Criminal](e.Data(asMap(data[0])))
	}
	return typedFrom[Criminal](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Criminal (all fields
// optional at the wire level).
func (e *CriminalEntity) MatchTyped(match ...Criminal) Criminal {
	if len(match) > 0 {
		return typedFrom[Criminal](e.Match(asMap(match[0])))
	}
	return typedFrom[Criminal](e.Match())
}
...
func (e *CriminalEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CriminalEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *CriminalEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CriminalListMatch and returns []Criminal. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CriminalEntity) ListTyped(reqmatch CriminalListMatch, ctrl map[string]any) ([]Criminal, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Criminal](res), nil
}



func (e *CriminalEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CriminalEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CriminalEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CriminalEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
