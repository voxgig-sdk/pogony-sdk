...
describe("CriminalDirect", function()
  it("should direct-list-criminal", function()
    local setup = criminal_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-criminal", setup.live and "live" or "unit")
