...
The Python SDK for the Pogony API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Criminal()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/pogony-sdk/releases)) or
...
# criminal contains the mock response record
```
