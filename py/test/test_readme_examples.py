# Pogony SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions PogonySDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both PogonySDK(...) and PogonySDK.test(...) become
#      PogonySDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "pogony_sdk"
_SDK_CLASS = "PogonySDK"
