# Pogony Python SDK Reference

Complete API reference for the Pogony Python SDK.
...
#### `PogonySDK.test(testopts=None, sdkopts=None)`
...
Create a new `CriminalEntity` instance. Pass `None` for no initial data.
...
Create a new `CriminalEntity` instance with the same options.
