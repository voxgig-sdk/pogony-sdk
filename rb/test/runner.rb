...
module PogonyTestRunner
  ...
  def self.env_override(m)
    live = getenv("POGONY_TEST_LIVE")
    override = getenv("POGONY_TEST_OVERRIDE")
    ...
    explain = getenv("POGONY_TEST_EXPLAIN")
    m["POGONY_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = PogonyTestRunner
Helpers = PogonyHelpers
Vs = VoxgigStruct
