// Command Pogony-cli is a CLI + REPL for the Pogony SDK,
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      POGONY_APIKEY (api key), POGONY_BASE (base url override)")
