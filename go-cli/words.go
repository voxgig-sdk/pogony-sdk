...
func registerSDKWords(r *eng.Registry, client *sdk.PogonySDK) {
...
func runOp(client *sdk.PogonySDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
