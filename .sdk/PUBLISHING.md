...
|---|---|---|
| `ts/` | @voxgig-sdk/pogony-sdk | `.github/workflows/publish-ts.yml` |
...
`ts` target it runs:
    ...
    npm trust github @voxgig-sdk/pogony-sdk \
      --repository voxgig-sdk/pogony-sdk \
      --file publish-ts.yml \
      --allow-publish
...
`npm trust list @voxgig-sdk/pogony-sdk` shows the configuration, and
`npm trust revoke @voxgig-sdk/pogony-sdk --id=<id>` removes one.
