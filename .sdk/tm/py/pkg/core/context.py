...
from projectname_sdk.core.control import PogonyControl
...
class PogonyContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, PogonyResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return PogonyError(code, msg, self)
