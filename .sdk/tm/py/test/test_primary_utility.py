...
from projectname_sdk import PogonySDK
from projectname_sdk.core.spec import PogonySpec
from projectname_sdk.core.result import PogonyResult
from projectname_sdk.core.response import PogonyResponse
from projectname_sdk.core.operation import PogonyOperation
from projectname_sdk.core.error import PogonyError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import PogonyBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = PogonySDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = PogonySDK.test(None, None)
        ...
        class TestInitFeature(PogonyBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(PogonyBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = PogonySpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = PogonySDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = PogonySDK.test(None, setup_opts)
