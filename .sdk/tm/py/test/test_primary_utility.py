...
_runner = makeRunner(TEST_JSON_FILE, PogonySDK.test(None, None))
...
def _auth_credential():
    ...
    ctx.spec = PogonySpec({"headers": {}, "query": {}})
    try:
...
class TestPrimaryUtility:
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = PogonySDK.test(None, setup.get('a') or {})
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = PogonySDK.test(None, setup.get('a') or {})
