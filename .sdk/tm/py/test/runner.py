...
class PogonyTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = PogonyTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = PogonyTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = PogonyTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
