...
// Pogony SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class PogonyMakeRequest
{
    public static function call(PogonyContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new PogonyResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new PogonyResponse($fetched);
        } else {
