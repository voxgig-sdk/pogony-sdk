...
class PogonyStreamingFeature extends PogonyBaseFeature
{
    ...
    private function _iterate(PogonyResult $result): \Generator
    {
    ...
    private function _streamable(PogonyContext $ctx): bool
    {
