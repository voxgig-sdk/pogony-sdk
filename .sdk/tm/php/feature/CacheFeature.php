...
class PogonyCacheFeature extends PogonyBaseFeature
{
    ...
    private function _through(PogonyContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
