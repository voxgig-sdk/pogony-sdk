...
class PogonyProxyFeature extends PogonyBaseFeature
{
    ...
    public function init(PogonyContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (PogonyContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
