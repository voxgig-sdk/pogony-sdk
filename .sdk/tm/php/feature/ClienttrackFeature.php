...
// Pogony SDK clienttrack feature
...
class PogonyClienttrackFeature extends PogonyBaseFeature
{
    ...
    public function PostConstruct(PogonyContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Pogony-SDK';
