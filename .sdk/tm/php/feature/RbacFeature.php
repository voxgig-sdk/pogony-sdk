...
class PogonyRbacFeature extends PogonyBaseFeature
{
    ...
    private function _required(PogonyContext $ctx): ?string
    {
    ...
    private function _reject(PogonyContext $ctx, string $required): void
    {
    ...
    private function _track(PogonyContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
