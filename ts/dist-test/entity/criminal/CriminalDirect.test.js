...
(0, node_test_1.describe)('CriminalDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-criminal', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-criminal', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.POGONY_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.PogonySDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['POGONY_TEST_CRIMINAL_ENTID'];
    ...
    const client = new __1.PogonySDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=CriminalDirect.test.js.map