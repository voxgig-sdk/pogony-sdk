...
class CriminalEntity extends PogonyEntityBase_1.PogonyEntityBase {
    ...
    make() {
        return new CriminalEntity(this._client, this.entopts());
    }
    async list(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<Criminal[]> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
}
exports.CriminalEntity = CriminalEntity;
//# sourceMappingURL=CriminalEntity.js.map